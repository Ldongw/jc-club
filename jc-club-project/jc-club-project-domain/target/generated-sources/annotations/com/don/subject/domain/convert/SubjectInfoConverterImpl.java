...
public class SubjectInfoConverterImpl implements SubjectInfoConverter {
    ...
    @Override
    public SubjectInfoBO convertOpAndInfoToBo(SubjectOptionBO subjectOptionBO, SubjectInfo subjectInfo) {
    ...
    @Override
    public List<SubjectInfoBO> convertToBoInfo(List<SubjectInfo> subjectInfoList) {
