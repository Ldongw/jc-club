package com.don.subject.infra.basic.service;
...
public interface SubjectBriefService {
    ...
    void insertBatch(List<SubjectBrief> subjectBriefList);

    SubjectBrief queryByCondition(SubjectBrief subjectBriefParam);
}
