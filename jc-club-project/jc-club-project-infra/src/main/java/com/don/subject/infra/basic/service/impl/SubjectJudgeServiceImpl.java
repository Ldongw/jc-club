...
import com.don.subject.infra.basic.mapper.SubjectJudgeDao;
...
public class SubjectJudgeServiceImpl implements SubjectJudgeService {
    ...
    @Override
    public List<SubjectJudge> queryByCondition(SubjectJudge subjectJudgeParam) {
        return this.subjectJudgeDao.queryAllByLimit(subjectJudgeParam);
    }
}
